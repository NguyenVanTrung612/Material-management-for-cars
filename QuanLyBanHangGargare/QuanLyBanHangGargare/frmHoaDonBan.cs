...
namespace QuanLyBanHangGargare
{
    public partial class frmHoaDonBan : Form
    {
        ...
        private void frmHoaDonBan_Load(object sender, EventArgs e)
        {
            ...
            Funtions.FillCombo("SELECT MaNhanVien, TenNhanVien FROM tblNhanVien", cboMaNhanVien, "MaNhanVien", "TenKhach");
        ...
        private void LoadDataGridView()
        {
            ...
            tblCTHDB = Funtions.GetDataToTable(sql);
        ...
        private void LoadInfoHoaDon()
        {
            ...
            dtpNgayBan.Value = DateTime.Parse(Funtions.GetFieldValues(str));
            str = "SELECT MaNhanVien FROM tblHDBan WHERE MaHDBan = N'" + txtMaHDBan.Text + "'";
            cboMaNhanVien.SelectedValue = Funtions.GetFieldValues(str);
            ...
            lblBangChu.Text = "Bằng chữ: " + Funtions.ChuyenSoSangChuoi(double.Parse(txtTongTien.Text));
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            ResetValues();
            txtMaHDBan.Text = Funtions.CreateKey("HDB");
            LoadDataGridView();
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sl = Convert.ToDouble(Funtions.GetFieldValues("SELECT SoLuong FROM tblHang WHERE MaHang = N'" + cboMaHang.SelectedValue + "'"));
            ...
            tong = Convert.ToDouble(Funtions.GetFieldValues("SELECT TongTien FROM tblHDBan WHERE MaHDBan = N'" + txtMaHDBan.Text + "'"));
            Tongmoi = tong + Convert.ToDouble(txtThanhTien.Text);
            sql = "UPDATE tblHDBan SET TongTien =" + Tongmoi + " WHERE MaHDBan = N'" + txtMaHDBan.Text + "'";
            Funtions.RunSQL(sql);
            txtTongTien.Text = Tongmoi.ToString();
            lblBangChu.Text = "Bằng chữ: " + Funtions.ChuyenSoSangChuoi(double.Parse(Tongmoi.ToString()));
            ResetValuesHang();
            btnXoa.Enabled = true;
            btnThem.Enabled = true;
            btnInHoaDon.Enabled = true;
        ...
        private void cboMaKhach_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtTenKhach.Text = Funtions.GetFieldValues(str);
            ...
            mtbDienThoai.Text = Funtions.GetFieldValues(str);
        }
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            tblThongtinHang = Funtions.GetDataToTable(sql);
            ...
            exRange.Range["A1:F1"].Value = "Bằng chữ: " + Funtions.ChuyenSoSangChuoi(double.Parse(tblThongtinHD.Rows[0][2].ToString()));
        ...
        {
            Funtions.FillCombo("SELECT MaHDBan FROM tblHDBan", cboMaHD, "MaHDBan", "MaHDBan");
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                DataTable tblHang = Funtions.GetDataToTable(sql);
                for (int hang = 0; hang <= tblHang.Rows.Count - 1; hang++)
                {
                    // Cập nhật lại số lượng cho các mặt hàng
                    sl = Convert.ToDouble(Funtions.GetFieldValues("SELECT SoLuong FROM tblHang WHERE MaHang = N'" + tblHang.Rows[hang][0].ToString() + "'"));
        ...
        private void dgvHDBanHang_DoubleClick(object sender, EventArgs e)
        {
            ...
            if ((MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes))
            {
                ...
                Funtions.RunSQL(sql);
                // Cập nhật lại số lượng cho các mặt hàng
                sl = Convert.ToDouble(Funtions.GetFieldValues("SELECT SoLuong FROM tblHang WHERE MaHang = N'" + MaHangxoa + "'"));
                slcon = sl + SoLuongxoa;
                ...
                Funtions.RunSQL(sql);
                txtTongTien.Text = tongmoi.ToString();
                lblBangChu.Text = "Bằng chữ: " + Funtions.ChuyenSoSangChuoi(tongmoi);
                LoadDataGridView();
            }
        }
    }
