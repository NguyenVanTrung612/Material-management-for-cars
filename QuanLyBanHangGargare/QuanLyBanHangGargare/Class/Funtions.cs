...
namespace QuanLyBanHangGargare.Class
{
    class Funtions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = Properties.Settings.Default.QLBanHangGarageConnectionString;
